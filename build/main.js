...
/***/ function(module, exports, __webpack_require__) {
	...
	var _homepage = __webpack_require__(168);
	
	var _homepage2 = _interopRequireDefault(_homepage);
	
	var _startpage = __webpack_require__(169);
	
	var _startpage2 = _interopRequireDefault(_startpage);
	
	var _quizpage = __webpack_require__(170);
	
	var _quizpage2 = _interopRequireDefault(_quizpage);
	
	var _failpage = __webpack_require__(172);
	
	var _failpage2 = _interopRequireDefault(_failpage);
	
	var _passpage = __webpack_require__(173);
	
	var _passpage2 = _interopRequireDefault(_passpage);
	  ...
	  _createClass(App, [{
	    ...
	    value: function _initialize() {
	      switch (this.state.page) {
	        case 'home':
	          return React.createElement(_homepage2.default, { navigate: this._loadPage.bind(this) });
	          break;
	        case 'start':
	          return React.createElement(_startpage2.default, { navigate: this._loadPage.bind(this) });
	          break;
	        case 'quiz':
	          return React.createElement(_quizpage2.default, { navigate: this._loadPage.bind(this) });
	          break;
	        case 'pass':
	          return React.createElement(_passpage2.default, { navigate: this._loadPage.bind(this) });
	          break;
	        case 'fail':
	          return React.createElement(_failpage2.default, { navigate: this._loadPage.bind(this) });
	          break;
	      }
	    }
	  }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	//The timer is imported here because it is shown on the quiz page.
	    ...
	    value: function _submitAnswer(button) {
	      ...
	      if (userAnswer === this.state.questionnaire[this.state.itemNum].answer) {
	        var newQuestionnaire = this.state.questionnaire.map(function (listblock) {
	          if (_this2.state.questionnaire[_this2.state.itemNum] === listblock) {
	    ...
	    value: function render() {
	      return React.createElement(
	        ...
	        React.createElement(
	          'div',
	          { className: 'clock' },
	          React.createElement(_timer2.default, { navigate: this._setFail.bind(this) })
	        ),
	        this.state.itemNum < 3 ? React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'button',
	              { className: 'submit-answer', onClick: this._submitAnswer.bind(this) },
	              'Submit'
	            )
	          )
	        ) : ''
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PassPage = function (_React$Component) {
